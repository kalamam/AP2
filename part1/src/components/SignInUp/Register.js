...
// const Register = ({DB, setDB, currentUser, setCurrentUser}) => {

const Register = ({user, setUser, setToken}) => {
    ...
    const handleSignUp = async (e) => {
        ...
        const encodedString = await readFileAsBase64(profilePicture);
        ...
        const newUser = {
            ...
            "profilePic": encodedString,
        };
        console.log(username + password + displayName + encodedString);
        // Sign up user
    ...
    return (
        <main>
            <div id="form-frame">
                <img className='like' src='media/likeemoji.jpg' />
                ...
                <form onSubmit={handleSignUp}>
                    ...
                    <div className="form-group">
                        ...
                        <input ref={displayNameBox} className="form-control" type="text" id="floatingDisplayName"
                            ...
                            onBlur={displayNameError} maxLength="30" required/>
            ...
            {profilePictureValid && (
                <>
                <p className="picture-text">Your uploaded picture:</p>
                <img className="picture-preview" src={URL.createObjectURL(profilePictureBox.current.files[0])} alt="Profile" />
                </>
            )}
            </div>
        </main>
